                    ...
                    <div class="">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item @if ($loop->first) active @endif">
                                ...
                                alt="{{ $announcement_to_check->title }}" height="600px" >
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="col-6 p-5">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Dettagli</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tags-tab" data-bs-toggle="tab" data-bs-target="#tags-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Tags</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="revisor-tab" data-bs-toggle="tab" data-bs-target="#revisor-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Revisione Immagini</button>
                    </li>
                </ul>
                <div class="tab-content p-4" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="revisor-tab-pane" role="tabpanel" aria-labelledby="revisor-tab" tabindex="0">
                        <div class="col-12">
                            <div class="card-body">
                                    <table class="table">
                                        <thead>
