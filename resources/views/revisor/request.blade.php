<x-layout>
    <div class="container">
        <div class="row justify-content-center">
            <h2 class="col-6 text-center text-primary mt-5">Entra nel Team</h2>
        </div>
    </div>
    <form action="{{route('become.revisor', Auth::user())}}" method="get" class="contact-form row justify-content-center align-items-center">
      @csrf
      <div class="col-lg-6">
         <label class="text-primary mt-3 mb-2">Inserisci le motivazioni per la tua candidatura: </label>
