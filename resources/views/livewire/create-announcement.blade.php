...
<<<<<<< HEAD
                            <button type="button" class=" btnImg"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" style="color: red" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    ...
                    <div id="boxImgPrev" class="col-12 my-2">
                        @if (!empty($images))
                        <div class="row">
                            <div class="col-12">
                                <p>Photo preview: </p>
                            ...
                            <div class="row justify-content-around ">
                                @foreach ($images as $key => $image)
                                    <div class="col-12 col-md-3 position-relative boxImg border" style="background-image: url('{{ $image->temporaryUrl() }}')">
                                        {{-- <img class=" img-preview shadow rounded " src="{{ $image->temporaryUrl() }}"> --}}
                                        {{-- <div  style="backgroud-image:url({{$image->temporaryUrl()}});"></div> --}}
                                        <button type="button" class=" btnImg"
                                            wire:click="removeImage({{ $key }})">
...
>>>>>>> 604894778c0fa49ca40ca1cf3475efeba9be6dd6
                        </div>
                        @endforeach
                        @endif
<<<<<<< HEAD
            ...
            <div class="row justify-content-center">
                <div class="col-6 text-center">
                    <button class="button-892 text-dark" role="button">ok</button>
                </div>
            </div>
=======
>>>>>>> 604894778c0fa49ca40ca1cf3475efeba9be6dd6
